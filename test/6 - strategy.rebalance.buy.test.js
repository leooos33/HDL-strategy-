...
describe("Strategy rebalance buy", function () {
    ...
    const wethInputR = "1302704116667181115";
    const usdcInputR = "29741599865";
    const osqthInputR = "23471345783386946879";
    ...
    it("rebalance", async function () {
        ...
        // Balances
        expect(await getERC20Balance(keeper.address, wethAddress)).to.equal("2605408233334362230");
        expect(await getERC20Balance(keeper.address, usdcAddress)).to.equal("59483199730");
        expect(await getERC20Balance(keeper.address, osqthAddress)).to.equal("0"); //TODO800641000891357
    ...
    //     const amount = await Vault._getTotalAmounts();
    //     console.log(amount);
